...
const Cart = () => {
        ...
        <hr/>
            <table class="table activitites">
                ...
                <tbody>
                    <tr>
                        <td class="item">
                                <div class="pl-2"> Suspended Heart Candles <div class="text-uppercase new"><span class="fas fa-star"></span>new</div>
                        ...
                        <td>120</td>
                        <td class="d-flex flex-column"><span class="red">$21.40</span> <del class="cross">$30.00</del> </td>
                        <td class="font-weight-bold"> $249 <div class="close">&times;</div> <button class="d-flex justify-content-end btn border">+ Add to cart</button> </td>
                    </tr>
                    <tr>
                        <td class="item">
                            <div class="d-flex align-items-start"> <img src="https://www.freepnglogos.com/uploads/corona-png-logo/corona-bottle-transparent-png-logo-27.png" alt=""/>
                                <div> Wine Bottle Shaped in Gift Base <div class="text-uppercase new"><span class="fas fa-star"></span>new</div>
                                    <div> <a href="#"> <span class="red text-uppercase"> <span class="fas fa-comment pr-1"></span> add a comment </span> </a> </div>
                                </div>
                            </div>
                        </td>
                        <td>120</td>
                        <td class="d-flex flex-column">$21.40 </td>
                        <td class="font-weight-bold"> $249 <div class="close">&times;</div> <button class="d-flex justify-content-end align-items-end btn border">+ Add to cart</button> </td>
                    </tr>
                    <tr>
                        <td class="item">
                            <div class="d-flex align-items-start"> <img src="https://www.freepnglogos.com/uploads/corona-png-logo/corona-bottle-transparent-png-logo-27.png" alt=""/>
                                <div> Copper Moscow Mug <div class="text-uppercase new"><span class="fas fa-star"></span>new</div>
                                    <div class="d-flex flex-column justify-content-center">
                    ...
                    <tr>
                        <td class="item">
                            <div class="d-flex align-items-start"> <img src="https://www.freepnglogos.com/uploads/corona-png-logo/corona-bottle-transparent-png-logo-27.png" alt=""/>
                                <div> Wine Bottle Shaped in Gift Base <div class="d-md-flex align-items-md-center">
                                        ...
                                        <div class="text-muted pl-md-5"> <span class="fas fa-comment"></span> <a href="#" class="comments text-muted"> + 7 comments </a> </div>
                                    </div>
                                    <div><a href="#"><span class="red text-uppercase"><span class="fas fa-comment pr-1"></span>add a comment</span></a> </div>
                                </div>
                            </div>
    ...
    <div class="d-flex justify-content-between">
        <div class="text-muted"> <button class="btn" type="button" data-toggle="collapse" data-target="#table" aria-expanded="false" aria-controls="table"> Hide <span class="fas fa-minus"></span> </button> </div>
        <div class="d-flex flex-column justify-content-end align-items-end">
            ...
            <div class="text-muted tag"> +add all the items to cart <span class="fas fa-shopping-cart pl-1"></span> </div>
        </div>
    </div>
</div>
    )
